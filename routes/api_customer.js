...
module.exports = function(app) {
  ...
  app.post('/api/integration/customers', function(req, res) {
    ...
    var applicable_attributes = {
      ...
      office_phone: req.body.phone,
      username: req.body.first_name + '_' + req.body.last_name + '_' + req.body.id
    }
    models.company.findOne({
      ...
      applicable_attributes['company_id'] = company.id;
      models.customer.findOne({
        ...
        if (customer) {
          models.customer.update(applicable_attributes);
        } else {
          models.customer.create(applicable_attributes);
        }
        res.end();
      });
    });
